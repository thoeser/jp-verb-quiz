...
var rules = {
  ...
  "iru": {
    ...
    "passive": { forms: [ { "result": "いられる" } ], },
    "passive negative": { forms: [ { "result": "いられない" } ], },
    "passive past": { forms: [ { "result": "いられた" } ], },
    "passive past negative": { forms: [ { "result": "いられなかった" } ], },
    "passive te-form": { forms: [ { "result": "いられて" } ], },
    "polite passive": { forms: [ { "result": "いられます" } ], },
    "polite passive negative": { forms: [ { "result": "いられません" } ], },
    "polite passive past": { forms: [ { "result": "いられました" } ], },
    "polite passive past negative": { forms: [ { "result": "いられませんでした" } ], },
    "causative": { forms: [ { "result": "いらせる" } ], },
    "causative negative": { forms: [ { "result": "いらせない" } ], },
    "causative past": { forms: [ { "result": "いらせた" } ], },
    "causative past negative": { forms: [ { "result": "いらせなかった" } ], },
    "causative passive": { forms: [ { "result": "いらせられる" } ], },
    "causative passive negative": { forms: [ { "result": "いらせられない" } ], },
    "causative passive past": { forms: [ { "result": "いらせられた" } ], },
    "causative passive past negative": { forms: [ { "result": "いらせられなかった" } ], },
    "volitional": { forms: [ { "result": "いろう" }, ], },
    "polite volitional": { forms: [ { "result": "いりましょう" }, ], },
    "provisional": { forms: [ { "result": "いれば" }, ], },
    "provisional negative": { forms: [ { "result": "いなければ" }, ], },
    "conditional": { forms: [ { "result": "いったら" }, ], },
    "conditional negative": { forms: [ { "result": "いなかったら" }, ], },
  },
